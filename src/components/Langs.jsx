      ...
      <div className="relative text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 lg:mt-20 mx-2 sm:mt-20">
          ...
          <div className="py-10 text-center border border-gray-800 rounded-lg">
            <div>
              ...
              <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
                <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500 " style={{ width: '86%' }}>
                  10 Years
                </div>
              </div>
            </div>
          ...
          <div className="py-10 text-center border border-gray-800 rounded-lg">
            ...
            <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
              <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500" style={{ width: '76%' }}>
                5 Years
              </div>
            </div>
          </div>
          ...
          <div className="py-10 text-center border border-gray-800 rounded-lg">
            ...
            <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
              <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500" style={{ width: '56%' }}>
                4 Years
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 mx-2 sm:mt-5">
        ...
        <div className="py-10 text-center border border-gray-800 rounded-lg">
          <div>
            ...
            <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
              <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500 " style={{ width: '84%' }}>
                9 Years
              </div>
            </div>
          </div>
        ...
        <div className="py-10 text-center border border-gray-800 rounded-lg">
          ...
          <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
            <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500" style={{ width: '46%' }}>
              2 Years
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 lg:mt-20 mx-2 sm:mt-20">
          ...
          <div className="py-10 text-center border border-gray-800 rounded-lg">
            <div>
              ...
              <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
                <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500 " style={{ width: '80%' }}>
                  5 Years
                </div>
              </div>
            </div>
          ...
          <div className="py-10 text-center border border-gray-800 rounded-lg">
            ...
            <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
              <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500" style={{ width: '40%' }}>
                2 Years
              </div>
            </div>
          </div>
          ...
          <div className="py-10 text-center border border-gray-800 rounded-lg">
            <div>
              ...
              <div className="w-full max-w-[80%] h-6 bg-gray-200 rounded-full dark:bg-gray-700 mt-5 mx-auto">
                <div className="h-6 bg-blue-600 rounded-full dark:bg-blue-500 " style={{ width: '54%' }}>
                  2 Years
                </div>
              </div>
            </div>
